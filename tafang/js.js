...
_TD.a.push(function(a) {
    ...
    var d = {
        _init: function(h) {
            ...
            this.select_hl = a.MapSelectHighLight(this.id + "-hl", {
                map: this
            });
            ...
            if (this.is_main_map) {
                this.mmm = new b(this.id + "-mmm", {
                    map: this
                });
                this.mmm.addToScene(this.scene, 1, 7)
            }
            var m, g = this.grid_x * this.grid_y,
                j = h.grid_data || [],
                n, k;
            for (m = 0; m < g; m++) {
                n = j[m] || {};
...
_TD.a.push(function(a) {
    var c = {
        ...
        fire: function() {
            ...
            var e = this.muzzle || [this.cx, this.cy],
                d = e[0],
                f = e[1];
            new a.Bullet(null, {
                building: this,
        ...
        upgrade: function() {
            ...
            var e = ["damage", "range", "speed", "life", "shield"],
                f, d = e.length;
            for (f = 0; f < d; f++) {
                this._upgrade2(e[f])
            }
    ...
    var b = {
        ...
        checkHit: function() {
            var d = this.cx,
                g = this.cy,
                f = this.r,
                e = this.map.anyMonster(function(h) {
    ...
    var b = {
        ...
        step: function() {
            ...
            if (this.cx == this.next_grid.cx && this.cy == this.next_grid.cy) {
                ...
                var d = this.next_grid.cx - this.cx,
                    h = this.next_grid.cy - this.cy,
                    g = d < 0 ? -1 : 1,
                    f = h < 0 ? -1 : 1,
                    e = this.speed * a.global_speed;
...
_TD.a.push(function(a) {
    var c = function() {
            var e = new a.Act(this, "act-1"),
                g = new a.Scene(e, "scene-1"),
                d = a.getDefaultStageData("scene_endless");
            ...
            var f = new a.Map("main-map", a.lang.mix({
                scene: g,
                is_main_map: true,
                step_level: 1,
                render_level: 2
            ...
            g.map = f;
            g.panel = new a.Panel("panel", a.lang.mix({
                scene: g,
                main_map: f,
                step_level: 1,
                render_level: 7
        ...
        b = function() {
            var f = this.current_act.current_scene,
                d = f.wave;
        ...
        var e = {
            ...
            scene_endless: {
                ...
                config: {
                    ...
                    money: ,
                    score: 0,
                    life: 100,
                    waves: [
                        [],
...
_TD.a.push(function(a) {
    function b() {
        ...
        if (a.show_monster_life) {
            var e = Math.floor(a.grid_size / 4),
                c = e * 2 - 2;
            d.fillStyle = "#000";
            d.beginPath();
    ...
    a.makeMonsters = function(f, j) {
        var p = [],
            k = 0,
            h, o, m, e, g = a.monster_type_count;
        if (!j) {
            j = [];
            for (h = 0; h < g; h++) {
                j.push(h)
...
_TD.a.push(function(a) {
    ...
    a._t = a.translate = function(c, d) {
        ...
        var f = this._msg_texts[c] || this._msg_texts._,
            e, b = d.length;
        for (e = 0; e < b; e++) {
            f = f.replace("${" + e + "}", d[e])
        }
